...
const PortfolioPage = () => {
    ...
    return (
        <div className="portfolio-container" style={{ padding: '2rem 0' }}>
            ...
            <div className="dashboard-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '1.5rem' }}>
                {/* Map Section */}
                <GlassCard style={{ gridColumn: 'span 8', height: '600px', padding: 0, overflow: 'hidden', position: 'relative' }}>
                            ...
                            {properties.map(p => {
                                ...
                                return (
                                    <tr key={p.id}>
                                        ...
                                        <td>{p.address}</td>
                                        <td>{formatCurrency(p.asset_value)}</td>
                                        <td>
